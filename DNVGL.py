...
class Agent():
    def __init__(self):
        ...
        self.x_pos = 0
        self.y_pos = 0
        self.number = 100 #changed from 50 #changed from 20
        self.R = 100
...
#                self.nxtpossat.append((self.nxtpos[0]-n,self.nxtpos[1]-m))
    ...
    def north_west(self):
        if self.chosen_pos[0] == 2019 or self.chosen_pos[1] ==2019:
            self.get_reward()
        else:
    ...
    def north_east(self):
        if self.chosen_pos[0] == -1961 or self.chosen_pos[1] == 2019:
            self.get_reward()
        else:
            self.nxtpos = (self.chosen_pos[0] - self.number, self.chosen_pos[1] + self.number)
            self.fakepos = (self.chosen_pos[0] - self.number*6, self.chosen_pos[1] + self.number*6)
    ...
    def south_west(self):
        if self.chosen_pos[0] == 2019 or self.chosen_pos[1] == -1961:
            self.get_reward()
        else:
            self.nxtpos = (self.chosen_pos[0] + self.number, self.chosen_pos[1] - self.number)
            self.fakepos = (self.chosen_pos[0] + self.number*6, self.chosen_pos[1] - self.number*6)
    ...
    def south_east(self):
        if self.chosen_pos[0] == -1961 or self.chosen_pos[1] == -1961:
            self.get_reward()
        else:
            self.nxtpos = (self.chosen_pos[0] - self.number, self.chosen_pos[1] - self.number)
            self.fakepos = (self.chosen_pos[0] - self.number*6, self.chosen_pos[1] - self.number*6)
